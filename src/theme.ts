...
export const PALETTES: Palette[] = [
  ...
  },
  {
    id: 'ember',
    name: 'EMBER',
    tagline: 'Molten amber on charcoal',
    pro: true,
    bg: '#0C0906',
    surface: '#181109',
    surfaceRaised: '#22180E',
    border: '#332514',
    borderSubtle: '#271C10',
    textPrimary: '#FBF2E6',
    ...
    textFaint: '#4A3D2E',
    accent: '#FFA23B',
    accentMuted: 'rgba(255, 162, 59, 0.16)',
    accentDim: '#9C5E17',
  ...
  },
  {
    id: 'matrix',
    name: 'MATRIX',
    tagline: 'Terminal green on true black',
    pro: true,
    bg: '#000000',
    surface: '#080D08',
    surfaceRaised: '#0D160D',
    border: '#172517',
    borderSubtle: '#111C11',
    textPrimary: '#DFFFE0',
    textSecondary: '#7FAF83',
    textTertiary: '#4E7551',
    textFaint: '#2B472D',
    accent: '#22FF6A',
    accentMuted: 'rgba(34, 255, 106, 0.14)',
    accentDim: '#12903C',
    accentContrast: '#001A08',
    danger: '#FF4557',
    dangerMuted: 'rgba(255, 69, 87, 0.16)',
  },
];
